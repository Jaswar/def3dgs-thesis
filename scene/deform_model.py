...
class DeformModel:
    def __init__(self, deform_depth, deform_width, is_blender=False, is_6dof=False):
        self.deform = DeformNetwork(deform_depth, deform_width, is_blender=is_blender, is_6dof=is_6dof).cuda()
        self.optimizer = None
